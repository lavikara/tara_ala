  ...
  return (
    <>
      <nav className={navClass}>
        <Link href="/" className="n-logo">Tara Ala</Link>
        ...
        <Link href="/contact" className="n-btn">Book a Consultation</Link>
      ...
      <div className={open ? 'n-drawer open' : 'n-drawer'}>
        ...
        <Link href="/contact" className="n-drawer-cta">Book a Consultation</Link>
      </div>
    </>
  );
}
